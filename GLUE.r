...
CultivarBatchFile<-"Basmati_385.RIC";
...
DSSATD<-"/ufrc/hoogenboom/ygao820/DSSAT47";
...
# This step is not necessary for HPCGLUE, need to manually create a batch file in GLWork directory.
# ## (6) Set up batch file.
